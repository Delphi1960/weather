...
export default function GetSunriseApi(dt: string) {
  // `https://api.met.no/weatherapi/sunrise/2.0/.json?${latitudeLongitude}&date=${dtSunrise}&offset=+02:00`
